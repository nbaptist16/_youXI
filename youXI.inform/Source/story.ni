...
the paper is a scenery in your room. it is fixed in place. the description is "the note reads:
	...
	unfortunately they aren't meant to be used to clean."
...
the hallway is south of your room. the description is "a simple hallway with maps and posters along the wall. to the north is your room, north east is Pipit's room, east leads further into the academy, west leads outside, south west is to the bathroom, and south leads to the dining hall."
...
the bathroom is southwest of the hallway. the description is "a rather spacious room with  a toilet, a sink, and a large tub. the exit is to the north east."
...
instead of reaching tub: say "you reach your hand inside the tub, and find your shield!                         (Maybe your should check it to make sure your friends didn't break it.)"; now the player carries your shield.
...
the potion container is scenery in the bathroom. the description is "inside you see a small note."
...
instead of examining table: say "you reach your hand under the table, and find your sword!                         now you are ready for training! (and just in time, too!)"; now the player carries your sword.

your sword is a thing. it is wearable. the description is "a sharp, lightweight, yet durable sword."

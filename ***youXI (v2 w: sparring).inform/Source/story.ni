...
outdoors is west of the hallway. the description is "A nice, large grassy field. You see your teacher, Horwell, and Pipit."
...
An every turn rule:
	if the score is 2:
		increase score by 1;
		say "Now we can begin today's training. Why don't we start off with some old-fasioned sparring? Put on your equipment and attack Pipit when you're ready."
